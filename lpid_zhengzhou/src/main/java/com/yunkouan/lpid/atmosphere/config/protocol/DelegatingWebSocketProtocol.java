 ...
 */
package com.yunkouan.lpid.atmosphere.config.protocol;
...
import com.yunkouan.lpid.atmosphere.dto.BaseCommand;
import com.yunkouan.lpid.atmosphere.dto.Command;
import com.yunkouan.lpid.atmosphere.dto.EmptyCommand;
import com.yunkouan.lpid.atmosphere.services.PushMessageService;
...
public class DelegatingWebSocketProtocol implements WebSocketProtocol {
    ...
    public List<AtmosphereRequest> onMessage(WebSocket webSocket, String message) {
        ...
        PushMessageService chatService = SpringApplicationContext.getBean(PushMessageService.class);
