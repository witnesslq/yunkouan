...
* @author  yangli 
* @date 2015年7月23日-下午5:34:30
* @version 1.0.0
*/ 
package com.yunkouan.lpid.biz.screenscompare.util.hcnet.dll64;
...
public interface HCNetSDK extends StdCallLibrary {
	public String path = HCNetSDK.class.getResource("").getFile();
	String filePath = new File(path).getPath() + File.separator + "HCNetSDK";
		
  HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary(filePath, HCNetSDK.class);
  /***宏定义***/
  //常量
	public static final int MAX_INDEX_LED = 8; // LED索引最大值 2013-11-19
	public static final int MAX_CUSTOM_DIR = 64; // 自定义目录最大长度
	public static final int URL_LEN_V40 = 256; // 最大URL长度
	public static final int CLOUD_NAME_LEN = 48; // 云存储服务器用户名长度
	public static final int CLOUD_PASSWD_LEN = 48; // 云存储服务器密码长度
	public static final int MAX_SENSORNAME_LEN = 64; // 传感器名称长度
	public static final int MAX_SENSORCHAN_LEN = 32; // 传感器通道长度
	public static final int MAX_DESCRIPTION_LEN = 32; // 传感器描述长度
	public static final int MAX_DEVNAME_LEN_EX = 64; // 设备名称长度扩展
	...
	public static final int  MAX_ICR_NUM   =          8 ;      //抓拍机红外滤光片预置点数2013-07-09
	public static final int MAX_HD_GROUP_V40   = 	32  ;    //设备最大硬盘组数
	public static final int MAX_SLAVECAMERA_NUM =    8 ;      //从摄像机个数
	public static final int MAX_CALIB_NUM    =       6 ;      //标定点的个数           
	...
	public static final int MAX_EVENTID_LEN  =       64;   //事件ID长度
	public static final int INVALID_VALUE_UINT32 =   0xffffffff;   //无效值
	public static final int COURSE_NAME_LEN		=		32;	//课程名称
	public static final int INSTRUCTOR_NAME_LEN		=	16;	//授课教师
	public static final int COURSE_DESCRIPTION_LEN	=	256	;//课程信息

	public static final int MAX_TIMESEGMENT_V40	=		16;	//每节课信息
	public static final int LEN_31		=			31 ;
	public static final int MAX_AUXAREA_NUM    =      16 ;  //辅助区域最大数目
	public static final int MAX_SLAVE_CHANNEL_NUM =   16 ;  //最大从通道数量
	public static final int UPNP_PORT_NUM	=		    12;	  //upnp端口映射端口数目
	...
	public static final int HOLIDAY_GROUP_NAME_LEN = 32; // 假日组名称长度
	public static final int MAX_HOLIDAY_PLAN_NUM = 16; // 假日组最大假日计划数
	...
	public static final int GROUP_NAME_LEN = 32; // 群组名称长度
	public static final int GROUP_COMBINATION_NUM = 8; // 群组组合数
	public static final int MULTI_CARD_GROUP_NUM = 4; // 单门最大多重卡组数
	public static final int ACS_CARD_NO_LEN = 32; // 门禁卡号长度
	public static final int CARD_PASSWORD_LEN = 8; // 卡密码长度
	public static final int MAX_DOOR_NUM = 32; // 最大门数
	public static final int MAX_CARD_RIGHT_PLAN_NUM = 4; // 卡权限最大计划个数
	public static final int MAX_CARD_READER_NUM = 64; // 最大读卡器数
	public static final int MAX_SNEAK_PATH_NODE = 8; // 最大后续读卡器数
	public static final int MAX_MULTI_DOOR_INTERLOCK_GROUP = 8; // 最大多门互锁组数
	public static final int MAX_INTER_LOCK_DOOR_NUM = 8; // 一个多门互锁组中最大互锁门数
	public static final int MAX_CASE_SENSOR_NUM = 8; // 最大case sensor触发器数
	public static final int PER_RING_PORT_NUM = 2; // 每个环的端口数

	/*******************全局错误码 begin**********************/	
	public static final int NET_DVR_INTERCOM_SDK_ERROR = 100; // 加载当前目录下的语音对讲库失败
	public static final int NET_DVR_USE_LOG_SWITCH_FILE = 103; // 正在使用日志开关文件
	public static final int NET_DVR_POOL_PORT_EXHAUST = 104; // 端口池中用于绑定的端口已耗尽
	public static final int NET_DVR_PACKET_TYPE_NOT_SUPPORT = 105;// 码流封装格式错误
	public static final int NET_DVR_IPPARA_IPID_ERROR = 106; // IP接入配置时IPID有误

	public static final int NET_DVR_LOAD_HCPREVIEW_SDK_ERROR = 107; // 预览组件加载失败
	public static final int NET_DVR_LOAD_HCVOICETALK_SDK_ERROR = 108; // 语音组件加载失败
	public static final int NET_DVR_LOAD_HCALARM_SDK_ERROR = 109; // 报警组件加载失败
	public static final int NET_DVR_LOAD_HCPLAYBACK_SDK_ERROR = 110; // 回放组件加载失败
	public static final int NET_DVR_LOAD_HCDISPLAY_SDK_ERROR = 111; // 显示组件加载失败
	public static final int NET_DVR_LOAD_HCINDUSTRY_SDK_ERROR = 112; // 行业应用组件加载失败
	public static final int NET_DVR_LOAD_HCGENERALCFGMGR_SDK_ERROR = 113; // 通用配置管理组件加载失败

	public static final int NET_DVR_CORE_VER_MISMATCH = 121; // 单独加载组件时，组件与core版本不匹配
	public static final int NET_DVR_CORE_VER_MISMATCH_HCPREVIEW = 122; // 预览组件与core版本不匹配
	public static final int NET_DVR_CORE_VER_MISMATCH_HCVOICETALK = 123; // 语音组件与core版本不匹配
	public static final int NET_DVR_CORE_VER_MISMATCH_HCALARM = 124; // 报警组件与core版本不匹配
	public static final int NET_DVR_CORE_VER_MISMATCH_HCPLAYBACK = 125; // 回放组件与core版本不匹配
	public static final int NET_DVR_CORE_VER_MISMATCH_HCDISPLAY = 126; // 显示组件与core版本不匹配
	public static final int NET_DVR_CORE_VER_MISMATCH_HCINDUSTRY = 127; // 行业应用组件与core版本不匹配
	public static final int NET_DVR_CORE_VER_MISMATCH_HCGENERALCFGMGR = 128; // 通用配置管理组件与core版本不匹配

	public static final int NET_DVR_COM_VER_MISMATCH_HCPREVIEW = 136; // 预览组件与HCNetSDK版本不匹配
	public static final int NET_DVR_COM_VER_MISMATCH_HCVOICETALK = 137; // 语音组件与HCNetSDK版本不匹配
	public static final int NET_DVR_COM_VER_MISMATCH_HCALARM = 138; // 报警组件与HCNetSDK版本不匹配
	public static final int NET_DVR_COM_VER_MISMATCH_HCPLAYBACK = 139; // 回放组件与HCNetSDK版本不匹配
	public static final int NET_DVR_COM_VER_MISMATCH_HCDISPLAY = 140; // 显示组件与HCNetSDK版本不匹配
	public static final int NET_DVR_COM_VER_MISMATCH_HCINDUSTRY = 141; // 行业应用组件与HCNetSDK版本不匹配
	public static final int NET_DVR_COM_VER_MISMATCH_HCGENERALCFGMGR = 142; // 通用配置管理组件与HCNetSDK版本不匹配
	public static final int NET_DVR_INVALID_COMMUNICATION = 151; // 无效通信
	public static final int NET_DVR_USERNAME_NOT_EXIST = 152; // 用户名不存在（用户名不存在，IPC5.1.7中发布出去了，所以删不掉。后续的产品这个错误码用不上）
	public static final int NET_DVR_USER_LOCKED = 153; // 用户被锁定
	public static final int NET_DVR_INVALID_USERID = 154;// 无效用户ID
	public static final int NET_DVR_LOW_LOGIN_VERSION = 155; // 登录版本低
	public static final int NET_DVR_LOAD_LIBEAY32_DLL_ERROR = 156; // 加载libeay32.dll库失败
	public static final int NET_DVR_LOAD_SSLEAY32_DLL_ERROR = 157; // 加载ssleay32.dll库失败

	public static final int NET_DVR_COUNTRYID_NOT_EXIST = 164; // 国家编号不存在, // hiddns上根据国家编号查询服务器地址时不存在这个国家编号
	public static final int NET_DVR_TEST_SERVER_FAIL_CONNECT = 165; // 连接测试服务器失败
	public static final int NET_DVR_NAS_SERVER_INVALID_DIR = 166; // NAS服务器挂载目录失败，目录无效
	public static final int NET_DVR_NAS_SERVER_NOENOUGH_PRI = 167;// NAS服务器挂载目录失败，没有权限
	public static final int NET_DVR_EMAIL_SERVER_NOT_CONFIG_DNS = 168; // 服务器使用域名，但是没有配置DNS，可能造成域名无效。
	public static final int NET_DVR_EMAIL_SERVER_NOT_CONFIG_GATEWAY = 169; // 没有配置网关，可能造成发送邮件失败。
	public static final int NET_DVR_TEST_SERVER_PASSWORD_ERROR = 170;// 用户名密码不正确，测试服务器的用户名或密码错误
	public static final int NET_DVR_EMAIL_SERVER_CONNECT_EXCEPTION_WITH_SMTP = 171; // 设备和smtp服务器交互异常
	public static final int NET_DVR_FTP_SERVER_FAIL_CREATE_DIR = 172; // FTP服务器创建目录失败
	public static final int NET_DVR_FTP_SERVER_NO_WRITE_PIR = 173; // FTP服务器没有写入权限
	public static final int NET_DVR_IP_CONFLICT = 174; // IP冲突
	public static final int NET_DVR_INSUFFICIENT_STORAGEPOOL_SPACE = 175; // 存储池空间已满
	public static final int NET_DVR_STORAGEPOOL_INVALID = 176; // 云服务器存储池无效,没有配置存储池或者存储池ID错误
	public static final int NET_DVR_EFFECTIVENESS_REBOOT = 177; // 生效需要重启
//	public static final int NET_DVR_QUICK_SETUP_PD_COUNT = (RAID_ERROR_INDEX + 42); /* 一键配置至少需要三块空闲盘 */

	// 设备未激活时，登录失败，返回错误码
	public static final int NET_DVR_ERROR_DEVICE_NOT_ACTIVATED = 250;// 设备未激活
	// 老SDK接新设备，设置用户密码或者激活的时候为风险密码时，错误码
	public static final int NET_DVR_ERROR_RISK_PASSWORD = 251; // 有风险的密码
	// 已激活的设备，再次激活时返回错误码
	public static final int NET_DVR_ERROR_DEVICE_HAS_ACTIVATED = 252;// 设备已激活
//	public static final int NET_DVR_CALIBRATE_DATA_CONFLICT = (VCA_ERROR_INDEX + 7); // 标定出错，以为所有点共线或者位置太集中
	public static final int NET_ERR_MAX_LOGO_NUM = 727;// logo数达到上限
	public static final int NET_ERR_MAX_WIN_LOOP_NUM = 728; // 轮巡窗口数达到上限
	public static final int NET_SDK_ERR_CHAN_AUDIO_BIND = 821; // 通道未绑定或绑定语音对讲失败
	// 云存储错误码
	public static final int NET_DVR_N_PLUS_ONE_MODE = 822; // 设备当前处于N+1模式
	public static final int NET_DVR_CLOUD_STORAGE_OPENED = 823; // 云存储模式已开启

	// 庭审主机错误码
	public static final int NET_SDK_ERR_IR_PORT_ERROR = 830; // 红外输出口错误
	public static final int NET_SDK_ERR_IR_CMD_ERROR = 831; // 红外输出口的命令号错误
	public static final int NET_ERR_SIGNAL_MAX_ENLARGE_TIMES = 928;// 信号源放大倍数超限
	public static final int NET_ERR_ONE_SIGNAL_MULTI_CROSS = 929;// 单个信号源不能多次跨屏
	public static final int NET_ERR_ULTRA_HD_SIGNAL_MULTI_WIN = 930;// 超高清信号源不能重复开窗
	public static final int NET_ERR_MAX_VIRTUAL_LED_WIDTH = 931; // 虚拟LED宽度大于限制值
	public static final int NET_ERR_MAX_VIRTUAL_LED_WORD_LEN = 932; // 虚拟LED字符数大于限制值
	public static final int NET_ERR_SINGLE_OUTPUTPARAM_CONFIG = 933;// 不支持单个显示输出参数设置
	public static final int NET_ERR_MULTI_WIN_BE_COVER = 934;// 多分屏窗口被覆盖
	public static final int NET_ERR_WIN_NOT_EXIST = 935; // 窗口不存在
	public static final int NET_ERR_WIN_MAX_SIGNALSOURCE = 936;// 窗口信号源数超过限制值
	public static final int NET_ERR_MULTI_WIN_MOVE = 937;// 对多分屏窗口移动
	public static final int NET_ERR_MULTI_WIN_YPBPR_SDI = 938; // YPBPR
																// 和SDI信号源不支持9/16分屏
	public static final int NET_ERR_DIFF_TYPE_OUTPUT_MIXUSE = 939; // 不同类型输出板混插
	public static final int NET_ERR_SPLIT_WIN_CROSS = 940;// 对跨屏窗口分屏
	public static final int NET_ERR_SPLIT_WIN_NOT_FULL_SCREEN = 941; // 对未满屏窗口分屏
	public static final int NET_ERR_SPLIT_WIN_MANY_WIN = 942; // 对单个输出口上有多个窗口的窗口分屏

	public static final int NET_ERR_LED_RESOLUTION = 946; // LED 分辨率大于输出分辨率
	// 民用错误码（1100～1200）
	public static final int NET_ERR_PLT_USERID = 1100; // 验证平台userid错误
	public static final int NET_ERR_TRANS_CHAN_START = 1101; // 透明通道已打开，当前操作无法完成
	public static final int NET_ERR_DEV_UPGRADING = 1102; // 设备正在升级
	public static final int NET_ERR_MISMATCH_UPGRADE_PACK_TYPE = 1103; // 升级包类型不匹配
	public static final int NET_ERR_DEV_FORMATTING = 1104; // 设备正在格式化
	public static final int NET_ERR_MISMATCH_UPGRADE_PACK_VERSION = 1105; // 升级包版本不匹配
	public static final int NET_ERR_PWD_CONFLICT = 1220; // 密码冲突
	public static final int NET_DVR_ERR_FTP_PORT = 1414; // FTP端口号非法（端口号重复或者异常）
	public static final int NET_DVR_ERR_FTP_CATALOGUE = 1415; // FTP目录名非法（启用多级目录，多级目录传值为空）
	public static final int NET_DVR_ERR_FTP_UPLOAD_TYPE = 1416; // FTP上传类型非法（单ftp只支持全部/双ftp只支持卡口和违章）
	public static final int NET_DVR_ERR_FLASH_PARAM_WRITE = 1417; // 配置参数时写FLASH失败
	public static final int NET_DVR_ERR_FLASH_PARAM_READ = 1418; // 配置参数时读FLASH失败
	public static final int NET_DVR_ERR_PICNAME_DELIMITER = 1419; // FTP图片命名分隔符非法
	public static final int NET_DVR_ERR_PICNAME_ITEM = 1420; // FTP图片命名项非法（例如
																// 分隔符）
	public static final int NET_DVR_ERR_PLATE_RECOGNIZE_TYPE = 1421; // 牌识区域类型非法
																		// （矩形和多边形有效性校验）
	public static final int NET_DVR_ERR_CAPTURE_TIMES = 1422; // 抓拍次数非法
																// （有效值是0～5）
	public static final int NET_DVR_ERR_LOOP_DISTANCE = 1423; // 线圈距离非法
																// （有效值是0～2000ms）
	public static final int NET_DVR_ERR_LOOP_INPUT_STATUS = 1424; // 线圈输入状态非法
																	// （有效值）
	public static final int NET_DVR_ERR_RELATE_IO_CONFLICT = 1425; // 测速组IO关联冲突
	public static final int NET_DVR_ERR_INTERVAL_TIME = 1426; // 连拍间隔时间非法
																// （0～6000ms）
	public static final int NET_DVR_ERR_SIGN_SPEED = 1427; // 标志限速值非法（大车标志限速不能大于小车标志限速
															// ）
	public static final int NET_DVR_ERR_PIC_FLIP = 1428; // 图像配置翻转 （配置交互影响）
	public static final int NET_DVR_ERR_RELATE_LANE_NUMBER = 1429; // 关联车道数错误
																	// (重复
																	// 有效值校验1～99)
	public static final int NET_DVR_ERR_TRIGGER_MODE = 1430; // 配置抓拍机触发模式非法
	public static final int NET_DVR_ERR_DELAY_TIME = 1431; // 触发延时时间错误(2000ms)
	public static final int NET_DVR_ERR_EXCEED_RS485_COUNT = 1432; // 超过最大485个数限制
	public static final int NET_DVR_ERR_RADAR_TYPE = 1433; // 雷达类型错误
	public static final int NET_DVR_ERR_RADAR_ANGLE = 1434; // 雷达角度错误
	public static final int NET_DVR_ERR_RADAR_SPEED_VALID_TIME = 1435; // 雷达有效时间错误
	public static final int NET_DVR_ERR_RADAR_LINE_CORRECT = 1436; // 雷达线性矫正参数错误
	public static final int NET_DVR_ERR_RADAR_CONST_CORRECT = 1437; // 雷达常量矫正参数错误
	public static final int NET_DVR_ERR_RECORD_PARAM = 1438; // 录像参数无效（预录时间不超过10s）
	public static final int NET_DVR_ERR_LIGHT_WITHOUT_COLOR_AND_DIRECTION = 1439; // 视频检测信号灯配置信号灯个数，但是没有勾选信号灯方向和颜色的
	public static final int NET_DVR_ERR_LIGHT_WITHOUT_DETECTION_REGION = 1440; // 视频检测信号灯配置信号灯个数，但是没有画检测区域
	public static final int NET_DVR_ERR_RECOGNIZE_PROVINCE_PARAM = 1441; // 牌识参数省份参数的合法性

	public static final int NET_DVR_ERR_SPEED_TIMEOUT = 1442; // IO测速超时时间非法（有效值大于0）
	public static final int NET_DVR_ERR_NTP_TIMEZONE = 1443; // ntp时区参数错误
	public static final int NET_DVR_ERR_NTP_INTERVAL_TIME = 1444; // ntp校时间隔错误
	public static final int NET_DVR_ERR_NETWORK_CARD_NUM = 1445; // 可配置网卡数目错误
	public static final int NET_DVR_ERR_DEFAULT_ROUTE = 1446; // 默认路由错误
	public static final int NET_DVR_ERR_BONDING_WORK_MODE = 1447; // bonding网卡工作模式错误
	public static final int NET_DVR_ERR_SLAVE_CARD = 1448;// slave网卡错误
	public static final int NET_DVR_ERR_PRIMARY_CARD = 1449; // Primary网卡错误
	public static final int NET_DVR_ERR_DHCP_PPOE_WORK = 1450; // dhcp和pppoE不能同时启动
	public static final int NET_DVR_ERR_NET_INTERFACE = 1451; // 网络接口错误
	public static final int NET_DVR_ERR_MTU = 1452;// MTU错误
	public static final int NET_DVR_ERR_NETMASK = 1453;// 子网掩码错误
	public static final int NET_DVR_ERR_IP_INVALID = 1454; // IP地址不合法
	public static final int NET_DVR_ERR_MULTICAST_IP_INVALID = 1455; // 多播地址不合法
	public static final int NET_DVR_ERR_GATEWAY_INVALID = 1456; // 网关不合法
	public static final int NET_DVR_ERR_DNS_INVALID = 1457; // DNS不合法
	public static final int NET_DVR_ERR_ALARMHOST_IP_INVALID = 1458; // 告警主机地址不合法
	public static final int NET_DVR_ERR_IP_CONFLICT = 1459; // IP冲突
	public static final int NET_DVR_ERR_NETWORK_SEGMENT = 1460; // IP不支持同网段
	public static final int NET_DVR_ERR_NETPORT = 1461; // 端口错误

	public static final int NET_DVR_ERR_PPPOE_NOSUPPORT = 1462; // PPPOE不支持
	public static final int NET_DVR_ERR_DOMAINNAME_NOSUPPORT = 1463; // 域名不支持
	public static final int NET_DVR_ERR_NO_SPEED = 1464; // 未启用测速功能
	public static final int NET_DVR_ERR_IOSTATUS_INVALID = 1465; // IO状态错误
	public static final int NET_DVR_ERR_BURST_INTERVAL_INVALID = 1466; // 连拍间隔非法
	public static final int NET_DVR_ERR_RESERVE_MODE = 1467; // 备用模式错误

	public static final int NET_DVR_ERR_LANE_NO = 1468; // 叠加车道号错误
	public static final int NET_DVR_ERR_COIL_AREA_TYPE = 1469; // 线圈区域类型错误
	public static final int NET_DVR_ERR_TRIGGER_AREA_PARAM = 1470; // 触发区域参数错误
	public static final int NET_DVR_ERR_SPEED_LIMIT_PARAM = 1471; // 违章限速参数错误
	public static final int NET_DVR_ERR_LANE_PROTOCOL_TYPE = 1472; // 车道关联协议类型错误

	public static final int NET_DVR_ERR_INTERVAL_TYPE = 1473; // 连拍间隔类型非法
	public static final int NET_DVR_ERR_INTERVAL_DISTANCE = 1474; // 连拍间隔距离非法
	public static final int NET_DVR_ERR_RS485_ASSOCIATE_DEVTYPE = 1475; // RS485关联类型非法
	public static final int NET_DVR_ERR_RS485_ASSOCIATE_LANENO = 1476; // RS485关联车道号非法
	public static final int NET_DVR_ERR_LANENO_ASSOCIATE_MULTIRS485 = 1477; // 车道号关联多个RS485口
	public static final int NET_DVR_ERR_LIGHT_DETECTION_REGION = 1478; // 视频检测信号灯配置信号灯个数，但是检测区域宽或高为0

	public static final int NET_DVR_ERR_DN2D_NOSUPPORT = 1479; // 不支持抓拍帧2D降噪
	public static final int NET_DVR_ERR_IRISMODE_NOSUPPORT = 1480; // 不支持的镜头类型
	public static final int NET_DVR_ERR_WB_NOSUPPORT = 1481; // 不支持的白平衡模式
	public static final int NET_DVR_ERR_IO_EFFECTIVENESS = 1482; // IO口的有效性
	public static final int NET_DVR_ERR_LIGHTNO_MAX = 1483; // 信号灯检测器接入红/黄灯超限(16)
	public static final int NET_DVR_ERR_LIGHTNO_CONFLICT = 1484; // 信号灯检测器接入红/黄灯冲突

	public static final int NET_DVR_ERR_CANCEL_LINE = 1485; // 直行触发线
	public static final int NET_DVR_ERR_STOP_LINE = 1486; // 待行区停止线
	public static final int NET_DVR_ERR_RUSH_REDLIGHT_LINE = 1487; // 闯红灯触发线
	public static final int NET_DVR_ERR_IOOUTNO_MAX = 1488; // IO输出口编号越界

	public static final int NET_DVR_ERR_IOOUTNO_AHEADTIME_MAX = 1489; // IO输出口提前时间超限
	public static final int NET_DVR_ERR_IOOUTNO_IOWORKTIME = 1490; // IO输出口有效持续时间超限
	public static final int NET_DVR_ERR_IOOUTNO_FREQMULTI = 1491; // IO输出口脉冲模式下倍频出错
	public static final int NET_DVR_ERR_IOOUTNO_DUTYRATE = 1492;// IO输出口脉冲模式下占空比出错
	public static final int NET_DVR_ERR_VIDEO_WITH_EXPOSURE = 1493; // 以曝闪起效，工作方式不支持视频
	public static final int NET_DVR_ERR_PLATE_BRIGHTNESS_WITHOUT_FLASHDET = 1494; // 车牌亮度自动使能闪光灯仅在车牌亮度补偿模式下起效

	public static final int NET_DVR_ERR_RECOGNIZE_TYPE_PARAM = 1495; // 识别类型非法
																		// 车牌识别参数（如大车、小车、背向、正向、车标识别等）
	public static final int NET_DVR_ERR_PALTE_RECOGNIZE_AREA_PARAM = 1496; // 牌识参数非法
																			// 牌识区域配置时判断出错
	public static final int NET_DVR_ERR_PORT_CONFLICT = 1497; // 端口有冲突
	public static final int NET_DVR_ERR_LOOP_IP = 1498;// IP不能设置为回环地址
	public static final int NET_DVR_ERR_DRIVELINE_SENSITIVE = 1499; // 压线灵敏度出错(视频电警模式下)

	// 抓拍机错误码新增扩展(1600~1900)
	public static final int NET_DVR_ERR_EXCEED_MAX_CAPTURE_TIMES = 1600; // 抓拍模式为频闪时最大抓拍张数为2张(IVT模式下)
	public static final int NET_DVR_ERR_REDAR_TYPE_CONFLICT = 1601; // 相同485口关联雷达类型冲突
	public static final int NET_DVR_ERR_LICENSE_PLATE_NULL = 1602; // 车牌号为空
	public static final int NET_DVR_ERR_WRITE_DATABASE = 1603;// 写入数据库失败
	public static final int NET_DVR_ERR_LICENSE_EFFECTIVE_TIME = 1604; // 车牌有效时间错误

	// 门禁主机错误码
	public static final int NET_ERR_TIME_OVERLAP = 1900; // 时间段重叠
	public static final int NET_ERR_HOLIDAY_PLAN_OVERLAP = 1901; // 假日计划重叠
	public static final int NET_ERR_CARDNO_NOT_SORT = 1902; // 卡号未排序
	public static final int NET_ERR_CARDNO_NOT_EXIST = 1903; // 卡号不存在
	public static final int NET_ERR_ILLEGAL_CARDNO = 1904; // 卡号错误
	public static final int NET_ERR_ZONE_ALARM = 1905; // 防区处于布防状态(参数修改不允许)
	public static final int NET_ERR_ZONE_OPERATION_NOT_SUPPORT = 1906; // 防区不支持该操作
	public static final int NET_ERR_INTERLOCK_ANTI_CONFLICT = 1907; // 多门互锁和反潜回同时配置错误
	public static final int NET_ERR_DEVICE_CARD_FULL = 1908; // 卡已满（卡达到10W后返回）

	// 民用错误码 从5001~6000
	public static final int NET_DVR_EZVIZ_NO_ENOUGH_DATA = 5001; // 接收的数据长度不够
	public static final int NET_DVR_EZVIZ_SDK_ERROR = 5002; // 民用通信库加载失败
	public static final int NET_DVR_EZVIZ_GENERAL_UNKNOW_ERROR = 5003; // 未知错误
	public static final int NET_DVR_EZVIZ_GENERAL_SERIAL_NOT_FOR_CIVIL = 5004; // 序列号解析失败
	public static final int NET_DVR_EZVIZ_GENERAL_SERIAL_FORBIDDEN = 5005; // 序列号被禁止
	public static final int NET_DVR_EZVIZ_GENERAL_SERIAL_DUPLICATE = 5006; // 序列号重复
	public static final int NET_DVR_EZVIZ_GENERAL_SERIAL_FLUSHED_IN_A_SECOND = 5007; // 相同序列号短时间内大量请求
	public static final int NET_DVR_EZVIZ_GENERAL_SERIAL_NO_LONGER_SUPPORTED = 5008; // 序列号不再支持

	public static final int NET_DVR_EZVIZ_PLATFORM_CLIENT_REQUEST_NO_PU_FOUNDED = 5009; // 请求的设备不在线
	public static final int NET_DVR_EZVIZ_PLAYFORM_CLIENT_REQUEST_REFUSED_TO_PROTECT_PU = 5010; // 为了保护设备，拒绝请求
	public static final int NET_DVR_EZVIZ_PLAYFORM_CLIENT_REQUEST_PU_LIMIT_REACHED = 5011; // 设备达到链接的客户端上限
	public static final int NET_DVR_EZVIZ_PLAYFORM_CLIENT_TEARDOWN_PU_CONNECTION = 5012; // 服务器要求客户端断开与设备的连接
	public static final int NET_DVR_EZVIZ_PLAYFORM_CLIENT_VERIFY_SESSION_ERROR = 5013; // 设备拒绝平台发送的客户端连接请求
	public static final int DRAG_PTZ = 51; /* 拖动PTZ */
	public static final int LINEAR_SCAN = 52; /* 区域扫描 */// 2014-03-15
	public static final int CLE_ALL_PRESET = 53; /* 预置点全部清除 */
	public static final int CLE_ALL_SEQ = 54; /* 巡航全部清除 */
	public static final int CLE_ALL_CRUISE = 55; /* 轨迹全部清除 */

	public static final int POPUP_MENU = 56; /* 显示操作菜单 */

	public static final int TILT_DOWN_ZOOM_IN = 58; /* * 云台以SS的速度下俯&&焦距以速度SS变大(倍率变大 * ) */
	public static final int TILT_DOWN_ZOOM_OUT = 59; /* * 云台以SS的速度下俯&&焦距以速度SS变小(倍率变小 * ) */
	public static final int PAN_LEFT_ZOOM_IN = 60; /* * 云台以SS的速度左转&&焦距以速度SS变大(倍率变大 * ) */
	public static final int PAN_LEFT_ZOOM_OUT = 61; /* * 云台以SS的速度左转&&焦距以速度SS变小(倍率变小 * ) */
	public static final int PAN_RIGHT_ZOOM_IN = 62; /* * 云台以SS的速度右转&&焦距以速度SS变大(倍率变大 * ) */
	public static final int PAN_RIGHT_ZOOM_OUT = 63; /* * 云台以SS的速度右转&&焦距以速度SS变小(倍率变小 * ) */
	public static final int UP_LEFT_ZOOM_IN = 64; /* * 云台以SS的速度上仰和左转&&焦距以速度SS变大(倍率变大) */
	public static final int UP_LEFT_ZOOM_OUT = 65; /* * 云台以SS的速度上仰和左转&&焦距以速度SS变小(倍率变小 * ) */
	public static final int UP_RIGHT_ZOOM_IN = 66; /* * 云台以SS的速度上仰和右转&&焦距以速度SS变大(倍率变大 * ) */
	public static final int UP_RIGHT_ZOOM_OUT = 67; /* * 云台以SS的速度上仰和右转&&焦距以速度SS变小(倍率变小 * ) */
	public static final int DOWN_LEFT_ZOOM_IN = 68; /* * 云台以SS的速度下俯和左转&&焦距以速度SS变大(倍率变大 * ) */
	public static final int DOWN_LEFT_ZOOM_OUT = 69; /* * 云台以SS的速度下俯和左转&&焦距以速度SS变小(倍率变小 * ) */
	public static final int DOWN_RIGHT_ZOOM_IN = 70; /* * 云台以SS的速度下俯和右转&&焦距以速度SS变大(倍率变大 * ) */
	public static final int DOWN_RIGHT_ZOOM_OUT = 71; /* * 云台以SS的速度下俯和右转&&焦距以速度SS变小(倍率变小 * ) */
	public static final int TILT_UP_ZOOM_IN = 72; /* 云台以SS的速度上仰&&焦距以速度SS变大(倍率变大) */
	public static final int TILT_UP_ZOOM_OUT = 73; /* * 云台以SS的速度上仰&&焦距以速度SS变小(倍率变小 * ) */

	public static final int DVR_VEHICLE_CONTROL_LIST = 0x1; // 车辆黑白名单数据类型(发送的数据类型)2013-11-04
	...
	public static final int  AUDIOTALKTYPE_AAC	=	 7;
	public static final int  AUDIOTALKTYPE_PCM	=	 8;

	public static final int NET_DVR_GET_PASSWORD_MANAGE_CFG = 144; // 获取密码管理配置
	public static final int NET_DVR_SET_PASSWORD_MANAGE_CFG = 145; // 设置密码管理配置
	public static final int NET_DVR_UNLOCK_USER = 146; // 用户解锁
	public static final int NET_DVR_GET_SECURITY_CFG = 147; // 获取安全认证配置
	public static final int NET_DVR_SET_SECURITY_CFG = 148; // 设置安全认证配置
	public static final int NET_DVR_GET_LOCKED_INFO_LIST = 149; // 获取所有被锁定信息
