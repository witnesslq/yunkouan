...
<html class="html-w">
  ...
  <body class="login-bg">
  	<input type="hidden" id="indexPage" value="index1"/>
	...
	<div class="login-main">
	    ...
	    <div class="login-content">
	        ...
	        <input class="form-control" id="password" placeholder="密码" type="password" tabIndex="2"/>
	    ...
	    <div class="login-footer">
	        <button id="login" class="btn btn-primary" type="button" tabIndex="3">登录</button>
	        <button id="reset" class="btn btn-default" type="button" tabIndex="4">重置</button>
	    </div>
	</div>
</body>
</html>
